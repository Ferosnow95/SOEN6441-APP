...
public class TweetService {
    ...
    public static void getTweetsAsync(String searchKeys, ActorRef user) {
        TwitterStream twitterStream = new TwitterStreamFactory().getInstance();
        getTweetsAsyncUtil(searchKeys, user, twitterStream);
    }
     ...
     * @author Ali Zafar Iqbal X Negin
     */
    public static void getTweetsAsyncUtil(String searchKeys, ActorRef user, TwitterStream twitter) {
        FilterQuery query = new FilterQuery(searchKeys);
        StatusListener listener = new StatusAdapter() {
            public void onStatus(Status tweet) {
                user.tell(new Tweet(tweet.getUser().getScreenName(), tweet.getText(), date.format(tweet.getCreatedAt())), user);
            }
